...
function step() {
    ...
    // 4 fps for the details in the animation, just like in aseprite
    let detail_anim_offset = Math.floor(4 * progress_seconds) % 4;
    document.body.style.setProperty("--detail-anim-offset", detail_anim_offset.toString());
