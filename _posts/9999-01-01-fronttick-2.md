...
> 
> *Hint for mathematicians:* Directly determine all $c$ such that $f(b) = b+c$ is valid for all four systems at once.
...
Using a look-up table like this, we get 4 Minecraft commands instead of the four/five/six we get when doing arithmetic. This is unnecessary/worth it/very worth it, but the amount of files generated hurts. Using a log-base different from 2 to get fewer files isn't even worth the effort, because then every branch takes at least 8 commands. I simply prefer the elegance of plain arithmetic:
